...
DATA_PATH = r"C:\Users\HARDWARE\Desktop\Kodingan Akhir\Speech-Recognition-TA\dataset\dataset_manual.json"
...
if __name__ == "__main__":
    ...
    sns.heatmap(confusion_mtx, xticklabels=["No","Yes"], yticklabels=["No","Yes"], 
                annot=True, fmt='g')
